...
<nav class="navbar navbar-expand navbar-dark bg-primary sticky-top">
    <div class="container-lg">
        <a class="navbar-brand" href="."><i class="bi bi-shop"></i> NilBakery</a>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-floating mb-3">
                                <input disabled type="email" class="form-control" id="floatingInput" placeholder="name@example.com" name="username" required value="<?php echo $_SESSION['username_bakery'] ?>">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-floating mb-3">
                                ...
                                <label for="floatingInput">Paswword Baru</label>
                                <div class="invalid-feedback">
                                    Mausukkan Password Baru.
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-floating mb-3">
                                ...
                                <div class="invalid-feedback">
                                    Mausukkan Ulangi Password Baru.
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-floating mb-3">
                                ...
                                <div class="invalid-feedback">
                                    Mausukkan Masukkan Alamat Anda.
                                </div>
                            </div>
                        </div>
                    </div>
