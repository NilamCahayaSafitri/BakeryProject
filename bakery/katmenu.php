                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <select class="form-select" name="jenismenu" id="">
                                                ...
                                                <option value="5">Kue</option>
                                            </select>
                                            <label for="floatingInput">Jenis Menu</label>
                                            <div class="invalid-feedback">
                                                Mausukkan Jenis Menu.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput" placeholder="KategoriMenu" name="katmenu" required>
                                            <label for="floatingInput">Kategori Menu</label>
                                            <div class="invalid-feedback">
                                                Mausukkan Kategori Menu.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <input type="hidden" value="<?php echo $row['id_kat_menu'] ?>" name="id">
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <?php 
                                        $data = array("Donat", "Roti", "Cake", "Cookie","Kue");
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="floatingInput" placeholder="KategoriMenu" name="katmenu" required value="<?php echo $row['kategori_menu'] ?>">
                                            <label for="floatingInput">Kategori Menu</label>
                                            <div class="invalid-feedback">
                                                Mausukkan Kategori Menu.
                                            </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo ($row['jenis_menu'] == 1) ? "Donat" : (($row['jenis_menu'] == 2) ? 
                                        "Roti" : (($row['jenis_menu'] == 3) ? "Cake" : (($row['jenis_menu'] == 4) ? "Cookie" : "Kue"))); ?>
                                    </td>
                                    <td>
