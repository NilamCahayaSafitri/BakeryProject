                        ...
                        <form class="needs-validation" novalidate action="proses/proses_input_user.php" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        ...
                                        <?php 
                                        $data = array("Admin", "Karyawan", "Kurir", "Pelanggan");
                    ...
                    <div class="modal-content">
                        ...
                        <input type="hidden" value="<?php echo $row['id']?>" name="id">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                            <input <?php echo ($row['username'] == $_SESSION['username_bakery']) ? 'disabled' : '' ?> type="email" class="form-control" id="floatingInput" 
                ...
                <div class="modal-dialog modal-md modal-fullscreen-md-down">
                    <div class="modal-content">
                        ...
                        <input type="hidden" value="<?php echo $row['id']?>" name="id">
                                <div class="col-lg-12">
                                    <?php 
                                    if($row['username'] == $_SESSION['username_bakery']){
                                        echo "<div class='alert alert-danger'>Anda tidak dapat menghapus akun sendiri</div>";
                                    }else{
                                        echo "Apakah anda yakin ingin menghapus user <b><?php echo $row[username] ?></b>";
                                    }
                                    ?>
                                ...
                                <div class="modal-footer">
                                    ...
                                    value="12345" <?php echo ($row['username'] == $_SESSION['username_bakery']) ? 'disabled' : '' ?>>Hapus</button>
                                </div>
                            </form>
                        </div>
                    </div>
                        ...
                        <input type="hidden" value="<?php echo $row['id']?>" name="id">
                                <div class="col-lg-12">
                                    ...
                                    if($row['username'] == $_SESSION['username_bakery']){
                                        ...
                                        echo "Apakah anda yakin ingin mereset password <b>$row[username] ?></b> 
                                ...
                                <div class="modal-footer">
                                    ...
                                    value="12345" <?php echo ($row['username'] == $_SESSION['username_bakery']) ? 'disabled' : '' ?>>Reset Password</button>
                                </div>
                            </form>
                        </div>
                    </div>
