...
<div class="col-lg-9  mt-2">
    <div class="card">
        ...
        <div class="card-body">
            <a href="order" class="btn btn-info mb-3"><i class="bi bi-arrow-left-square"></i></a>
            <div class="row">
                <div class="col-lg-4">
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/proses_input_orderitem.php" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-floating mb-3">
                                            <input type="number" class="form-control" id="floatingInput" placeholder="jumlahorder" name="jumlah" required>
                                            <label for="floatingInput">Jumlah Menu</label>
                                            <div class="invalid-feedback">
                                                Mausukkan Jumlah Order.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="modal-body">
                                    <form class="needs-validation" novalidate action="proses/proses_edit_orderitem.php" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-floating mb-3">
                                                    <input type="number" class="form-control" id="floatingInput" placeholder="jumlahorder" name="jumlah" required value="<?php echo $row['jumlah'] ?>">
                                                    <label for="floatingInput">Jumlah Menu</label>
                                                    <div class="invalid-feedback">
                                                        Mausukkan Jumlah Order.
                                                    </div>
                    ...
                    <div class="modal-dialog modal-lg modal-fullscreen-md-down">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <span class="text-danger fs-5 fw-sembold">Apakah Anda Yakin Ingin Melakukan Pembayaran</span>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            "btn btn-warning btn-sm me-1"; ?>" data-bs-toggle="modal" data-bs-target="#ModalEdit<?php echo $row['id_list_order'] ?>"><i class="bi bi-pencil-fill"></i></button>
                                            <button class="<?php echo (!empty($row['id_bayar'])) ? "btn btn-secondary btn-sm me-1 disabled" : 
                                            "btn btn-danger btn-sm me-1"; ?>" data-bs-toggle="modal" data-bs-target="#ModalDelete<?php echo $row['id_list_order'] ?>"><i class="bi bi-trash"></i></button>
                                        </div>
                                    </td>
                                </tr>
                            <?php
            ...
            ?>
            <div>
                <button class="<?php echo (!empty($row['id_bayar'])) ? "btn btn-secondary disabled" : "btn btn-success"; ?>" data-bs-toggle="modal" data-bs-target="#tambahItem">
                    <i class="bi bi-bag-plus-fill"></i> Tambah Item</button>
                <button class="<?php echo (!empty($row['id_bayar'])) ? "btn btn-secondary disabled" : "btn btn-primary"; ?>" data-bs-toggle="modal" data-bs-target="#bayar">
                    <i class="bi bi-cash-coin"></i> Bayar</button>
            </div>
        </div>
    </div>
</div>